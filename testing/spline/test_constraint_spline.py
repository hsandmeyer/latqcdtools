...
print_results(spline_ind_sel(coeffs, constraints, knots, order, nsteady), [3, 2, 5, 4, 7],
        text = "Index selection test")



for constraint in constraints:
    print_results(constraint_spline(constraint[0], knots, coeffs, order, nsteady,
...
print_results(spline_ind_sel(coeffs, constraints, knots, order, nsteady), [3, 2, 4, 5],
        text = "Index selection test")
...
print_results(spline_ind_sel(coeffs, constraints, knots, order, nsteady), [3, 2, 7, 6, 5],
        text = "Index selection test")
