...
try:
    ...
    raise ImportError("latqcdtools requires numpy %s or later" %
                      (_min_numpy_version,))

try:
    import scipy
except ImportError:
    raise ImportError("latqcdtools requires scipy %s or later" %
                      (_min_scipy_version,))

try:
    import matplotlib
except ImportError:
    raise ImportError("latqcdtools requires matplotlib %s or later" %
                      (_min_matplot_version,))
