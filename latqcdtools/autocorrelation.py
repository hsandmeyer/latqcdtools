...
# Error computation according to Box, Jenkins, Reinsel: "Time series analysis", third edition, p. 33, equation 2.1.13
# This method of calculating autocorrelation does not remove the bias, which means it becomes slightly
# wrong in the limit of uncorrelated data.
